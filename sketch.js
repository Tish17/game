...
let relativeGravity = 2.5;
let relativeJumpHeight = 0.25;
...
function setup() {
  ...
  textSize(50);
  jumpHeight = height * relativeJumpHeight;
  gravity = height * relativeGravity;
  let jumpVelocity = -Math.sqrt(2 * gravity * jumpHeight);
  ball = new Ball(jumpVelocity, gravity);
